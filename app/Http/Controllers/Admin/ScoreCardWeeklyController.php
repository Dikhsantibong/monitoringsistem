...
class ScoreCardWeeklyController extends Controller
{
    public function create()
    {
        ...
        return view('admin.score-card.create-weekly', compact('defaultPeserta', 'waktuMulai', 'waktuSelesai'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.score-card.index')->with('success', 'Score Card Weekly berhasil dibuat');
    }
}

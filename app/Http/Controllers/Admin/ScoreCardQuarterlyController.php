...
class ScoreCardQuarterlyController extends Controller
{
    public function create()
    {
        ...
        return view('admin.score-card.create-quarterly', compact('defaultPeserta', 'waktuMulai', 'waktuSelesai'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.score-card.index')->with('success', 'Score Card Quarterly berhasil dibuat');
    }
}

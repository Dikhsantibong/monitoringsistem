        ...
        <header class="bg-white shadow-sm sticky top-0">
            <div class="flex justify-between items-center px-6 py-3">
                <div class="flex items-center gap-x-3">
                    ...
                    <h1 class="text-xl font-semibold text-gray-800">Data Pengajuan Material</h1>
                </div>
        ...
        <main class="px-6 pt-6">
            <div class="mb-4 flex justify-end">
                <form method="GET" action="" class="flex gap-2">
                    ...
                    @if(!empty($search))
                        <a href="{{ route('inventory.pengajuan-material.index') }}" class="px-4 py-2 rounded border">Reset</a>
                    @endif
                </form>
            </div>
            <div class="bg-white rounded-lg shadow p-6 w-full">
                <h2 class="text-lg font-semibold mb-4">Daftar Pengajuan Material</h2>
                <div class="overflow-x-auto">
                    <table class="min-w-full bg-white border border-gray-200">
                        ...
                        <tbody>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 py-2 text-center text-gray-500">Belum ada data pengajuan material.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>

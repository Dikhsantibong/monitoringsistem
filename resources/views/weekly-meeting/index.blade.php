                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    @foreach($machineIssuesNextWeek as $item)
                        <tr class="hover:bg-gray-50 transition-colors">
                            ...
                            <td class="px-6 py-4 text-red-700 font-semibold">Issue Mesin</td>
                            <td class="px-6 py-4">{{ $item->deskripsi ?? $item->status }}</td>
                            <td class="px-6 py-4">{{ $item->unit_source }}</td>
                            <td class="px-6 py-4 text-center">{{ optional($item->tanggal_mulai)->format('d/m/Y') }}</td>
                            <td class="px-6 py-4 text-center">{{ optional($item->target_selesai)->format('d/m/Y') }}</td>
                            <td class="px-6 py-4">@include('weekly-meeting.status-badge', ['status'=>$item->status])</td>
                        </tr>
                    @endforeach
                </tbody>
            </table>

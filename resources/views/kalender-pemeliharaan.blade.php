            ...
            <div class="calendar-sticky-nav">
                <div class="flex flex-col md:flex-row items-center justify-between gap-2 flex-wrap">
                    ...
                    <div class="flex gap-2">
                        <a href="{{ route('kalender.pemeliharaan', array_merge(['month' => $month == 12 ? 1 : $month + 1, 'year' => $month == 12 ? $year + 1 : $year], array_filter(['status' => $statusFilter, 'worktype' => $workTypeFilter, 'unit' => $unitFilter]))) }}" class="calendar-nav-btn">Bulan Berikutnya &raquo;</a>
                    </div>
                </div>
                </div>

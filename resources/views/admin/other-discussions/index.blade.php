                            ...
                            <div class="relative">
                                ...
                                <div class="relative">
                                    <input type="text" name="search" id="search"
                                        placeholder="Cari topik, PIC, unit..." value="{{ request('search') }}"
                        ...
                        <div class="border-b border-gray-200">
                            <nav class="-mb-px flex">
                                <button onclick="switchTab('active')"
                                    class="tab-btn active-tab py-4 px-6 font-medium text-sm" id="active-tab">
                                    Data Aktif
                                </button>
                                <button onclick="switchTab('overdue')" class="tab-btn py-4 px-6 font-medium text-sm"
                                    id="overdue-tab">
                                    Melewati Deadline
                                ...
                                <button onclick="switchTab('closed')" class="tab-btn py-4 px-6 font-medium text-sm"
                                    id="closed-tab">
                                    Data Selesai
                                </button>
                            </nav>
                                    ...
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">
                                            <div class="flex items-center justify-between">
                                                <span>Unit</span>
                                                <div class="relative">
                                                    <select id="unitTableFilterActive" name="unit"
                                                        onchange="filterTableByUnitActive()"
                                                        class="appearance-none bg-transparent text-white cursor-pointer pl-2 pr-6 py-0 text-sm focus:outline-none">
                                                        <option value="">Semua</option>
                                                        @foreach ($units as $unit)
                                                            <option value="{{ $unit }}" class="text-gray-700"
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Target
                                        </th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Risk Level
                                        </th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Priority
                                            Level</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Previous
                                            Commitment</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Next
                                            Commitment</th>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">
                                            <div class="flex items-center justify-between">
                                                <span>Status</span>
                                                <div class="relative">
                                                    <select id="statusTableFilterActive"
                                                        onchange="filterTableByStatusActive()"
                                                        class="appearance-none bg-transparent text-white cursor-pointer pl-2 pr-6 py-0 text-sm focus:outline-none">
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Deadline
                                        </th>
                                    ...
                                    @forelse($activeDiscussions as $index => $discussion)
                                        <tr data-id="{{ $discussion->id }}">
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                {{ $index + 1 }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                {{ $discussion->sr_number }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                {{ $discussion->wo_number }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                {{ $discussion->unit }}</td>
                                            <td
                                                class="px-6 py-4 whitespace-normal border border-gray-200 max-w-[400px] break-words">
                                                {{ $discussion->topic }}</td>
                                            <td
                                                class="px-6 py-4 whitespace-normal border border-gray-200 max-w-[400px] break-words">
                                                {{ $discussion->target }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                <span
                                                ...
                                                @elseif($discussion->risk_level == 'T') bg-red-100 text-red-800 @endif">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                ...
                                                @elseif($discussion->priority_level == 'High') bg-red-100 text-red-800 @endif">
                                                    {{ $discussion->priority_level }}
                                                </span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                {{ $discussion->previous_commitment }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                {{ $discussion->next_commitment }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                {{ $discussion->pic }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                <span
                                                ...
                                                @elseif($discussion->status == 'Overdue') bg-red-100 text-red-800 @endif">
                                                    {{ $discussion->status }}
                                                </span>
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap border border-gray-200">
                                                {{ \Carbon\Carbon::parse($discussion->deadline)->format('d/m/Y') }}</td>
                            ...
                            <table class="min-w-full divide-y divide-gray-200">
                                <thead class="bg-[#0A749B]">
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Topik</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Sasaran
                                        </th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Tingkat
                                            Resiko</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Tingkat
                                            Prioritas</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Komitmen
                                            Sebelum</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Komitmen
                                            Selanjutnya</th>
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">PIC</th>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">Tanggal
                                            Selesai</th>
                                    </tr>
                                </thead>
                                <tbody class="bg-white divide-y divide-gray-200">
                                    @forelse($closedDiscussions as $index => $discussion)
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap max-w-[400px] break-words">
                                                {{ $discussion->topic }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap max-w-[400px] break-words">
                                                {{ $discussion->target }}</td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $discussion->previous_commitment }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap">{{ $discussion->next_commitment }}
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                {{ $discussion->deadline->format('d/m/Y') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                {{ $discussion->closed_at->format('d/m/Y') }}</td>
                                        </tr>
                                    @empty
                                        <tr>
                                            <td colspan="14" class="px-6 py-4 text-center text-gray-500">
                                    ...
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">
                                            <div class="flex items-center justify-between">
                                                <span>Unit</span>
                                                <div class="relative">
                                                    <select id="unitTableFilterOverdue" name="unit"
                                                        onchange="filterTableByUnitOverdue()"
                                                        class="appearance-none bg-transparent text-white cursor-pointer pl-2 pr-6 py-0 text-sm focus:outline-none">
                                                        <option value="">Semua</option>
                                                        @foreach ($units as $unit)
                                                            <option value="{{ $unit }}" class="text-gray-700"
                                        ...
                                        <th class="px-6 py-3 text-left text-xs font-medium text-white uppercase">
                                            <div class="flex items-center justify-between">
                                                <span>Status</span>
                                                <div class="relative">
                                                    <select id="statusTableFilterOverdue" name="status"
                                                        onchange="filterTableByStatusOverdue()"
                                                        class="appearance-none bg-transparent text-white cursor-pointer pl-2 pr-6 py-0 text-sm focus:outline-none">
                                                        <option value="">Semua</option>
                                                        <option value="Open"
                                                            {{ request('status') == 'Open' ? 'selected' : '' }}
                                                            class="text-gray-700"></option>Open</option>
                                                        <option value="Closed"
                                                            {{ request('status') == 'Closed' ? 'selected' : '' }}
                                                            class="text-gray-700">Closed</option>
                                                        <option value="Overdue"
                                                            {{ request('status') == 'Overdue' ? 'selected' : '' }}
                                                            class="text-gray-700">Overdue</option>
                                                    </select>
                                                    <div
                                                        class="pointer-events-none absolute inset-y-0 right-0 flex items-center px-2">
                                                        <svg class="h-4 w-4 fill-current text-white" viewBox="0 0 20 20">
                                    ...
                                    @forelse($overdueDiscussions as $index => $discussion)
                                        <tr class="hover:bg-red-50">
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                {{ $discussion->deadline->format('d/m/Y') }}</td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                {{ $discussion->closed_at ? $discussion->closed_at->format('d/m/Y') : '-' }}
                                            </td>
                                            <td class="px-6 py-4 whitespace-nowrap text-sm">
                                                <div class="flex items-center space-x-3">
                                                    <!-- Edit -->
    ...
    <script>
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    fetch(`/admin/other-discussions/${id}`, {
                        ...
                        .then(response => response.json()) // Ubah ini
                        .then(data => {
                            if (data.success) {
        ...
        function filterTableByUnit() {
            ...
            tables.forEach(tableId => {
                ...
                rows.forEach(row => {
                    const unitCell = row.querySelector(
                    'td:nth-child(4)'); // Sesuaikan dengan posisi kolom unit
        ...
        function filterTableByStatus() {
            ...
            tables.forEach(tableId => {
                ...
                rows.forEach(row => {
                    ...
                    'td:nth-child(12)'); // Sesuaikan dengan posisi kolom status

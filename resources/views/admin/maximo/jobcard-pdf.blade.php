...
/* 
 * PERBAIKAN UTAMA: Gunakan running element untuk header yang repeat di setiap halaman.
 * Untuk kompatibilitas maksimal dengan wkhtmltopdf / DomPDF / Snappy,
 * kita pakai pendekatan: setiap .page punya header-nya sendiri,
 * dan gunakan CSS counter + page-break yang benar.
 */
...
/* Header dalam setiap halaman - selalu muncul di atas */
.page-header {
    width: 100%;
...
/* PERBAIKAN: kolom No dipersempit dari 6% ke 4% */
.jsa-col-no { width:4%; }
...
/* 
 * PERBAIKAN OVERFLOW: 
 * Untuk konten yang mungkin overflow ke halaman baru,
 * gunakan wrapper table dengan thead yang repeat.
 * Ini memastikan header muncul di setiap halaman baru.
 */
...
.repeating-header-table thead tr td {
    padding-bottom: 8px;
}
...
<!--
    PERBAIKAN: Setiap halaman menggunakan struktur tabel dengan thead repeating.
    Ini memastikan jika konten overflow, header tetap muncul di halaman baru.
    
    Cara kerja:
    - Bungkus seluruh konten halaman dalam <table class="repeating-header-table">
    - Taruh header di <thead> — browser/PDF engine akan repeat thead di setiap page break
    - Konten utama di <tbody>
-->
<div class="page">
  <table class="repeating-header-table">
    <thead>
      <tr>
        <td>
          <table style="width:100%; border-bottom:2px solid #000; padding-bottom:6px; margin-bottom:8px;">
            <tr>
    ...
    <tbody>
      <tr>
        <td>
          ...
          <!-- PERBAIKAN JSA TABLE: thead di-repeat saat overflow halaman, kolom No dipersempit -->
          <table class="jsa-tbl">
            <colgroup>
...
<div class="page" style="page-break-after: auto;">
  <table class="repeating-header-table">
    ...
    <tbody>
      <tr>
        <td>
          <!-- Konten halaman 6 (kosong / cadangan) -->
          &nbsp;
        </td>
      </tr>
    </tbody>

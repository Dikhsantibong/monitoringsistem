    ...
    <div id="main-content" class="flex-1 overflow-auto">
        ...
        <main class="px-6 mt-4 pb-8">
            <div class="flex justify-end mb-4">
                <a href="{{ route('admin.maximo.index', ['tab' => 'sr']) }}" class="inline-flex items-center px-6 py-2.5 bg-[#009BB9] text-white text-sm font-bold rounded-xl shadow-md hover:bg-[#007b94] hover:shadow-lg transition-all transform hover:-translate-y-0.5">
                    <i class="fas fa-arrow-left mr-2"></i> Kembali ke Daftar Service Request
                </a>
            </div>
            {{-- Header Card --}}

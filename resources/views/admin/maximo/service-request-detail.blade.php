...
<div class="flex h-screen bg-gray-50 overflow-auto">
    ...
    <div id="main-content" class="flex-1 overflow-auto">
        ...
        <main class="px-6 mt-4 pb-8">
            <div class="mb-4">
                <a href="{{ route('admin.maximo.index', ['tab' => 'sr']) }}" class="group inline-flex items-center text-sm font-medium text-gray-500 hover:text-[#009BB9] transition-colors">
                    ...
                    Kembali ke Daftar Service Request
                </a>
            </div>
            {{-- Header Card --}}

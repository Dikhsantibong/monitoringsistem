        ...
        <main class="px-6 mt-4 pb-8">
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mb-5">
                <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3">
                    ...
                    <div class="flex items-center gap-3 flex-wrap">
                        ...
                        @if($sr['faultpriority'] !== '-')
                        <span class="px-3 py-1 text-sm font-medium rounded-full bg-red-50 text-red-700">
                            Priority: {{ $sr['faultpriority'] }}
                        </span>
                        @endif
                        @if($sr['faulttype'] !== '-')
                        <span class="px-3 py-1 text-sm font-medium rounded-full bg-orange-50 text-orange-700">
                            {{ $sr['faulttype'] }}
                        </span>
                        @endif
                    </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-5">
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                    ...
                    <dl class="text-sm space-y-2">
                        <div class="flex justify-between gap-4 py-1 border-b border-gray-50">
                            <dt class="text-gray-500 whitespace-nowrap">Asset</dt>
                            <dd class="font-medium text-gray-800 text-right">{{ $sr['assetnum'] }}</dd>
                        </div>
                        @if($sr['asset_description'] !== '-')
                        <div class="flex justify-between gap-4 py-1 border-b border-gray-50">
                            <dt class="text-gray-500 whitespace-nowrap">Asset Description</dt>
                            <dd class="font-medium text-gray-800 text-right">{{ $sr['asset_description'] }}</dd>
                        </div>
                        @endif
                        <div class="flex justify-between gap-4 py-1 border-b border-gray-50">
                            <dt class="text-gray-500 whitespace-nowrap">Location</dt>
                            <dd class="font-medium text-gray-800 text-right">{{ $sr['location'] }}</dd>
                        </div>
                        @if($sr['location_description'] !== '-')
                        <div class="flex justify-between gap-4 py-1 border-b border-gray-50">
                            <dt class="text-gray-500 whitespace-nowrap">Location Description</dt>
                            <dd class="font-medium text-gray-800 text-right">{{ $sr['location_description'] }}</dd>
                        </div>
                        @endif
                        <div class="flex justify-between gap-4 py-1 border-b border-gray-50">
                            <dt class="text-gray-500 whitespace-nowrap">Site ID</dt>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                    <h3 class="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                        <i class="fas fa-user text-purple-500"></i> Pelapor
                    </h3>
                    <dl class="text-sm space-y-2">
                        <div class="flex justify-between gap-4 py-1 border-b border-gray-50">
                            <dt class="text-gray-500 whitespace-nowrap">Reported By</dt>
                            <dd class="font-medium text-gray-800 text-right">{{ $sr['reportedby'] }}</dd>
                        </div>
                        @if($sr['reportedby_name'] !== '-')
                        <div class="flex justify-between gap-4 py-1 border-b border-gray-50">
                            <dt class="text-gray-500 whitespace-nowrap">Nama</dt>
                            <dd class="font-medium text-gray-800 text-right">{{ $sr['reportedby_name'] }}</dd>
                        </div>
                        @endif
                        <div class="flex justify-between gap-4 py-1 border-b border-gray-50">
                            <dt class="text-gray-500 whitespace-nowrap">Report Date</dt>
                            <dd class="font-medium text-gray-800 text-right">{{ $sr['reportdate'] }}</dd>
                        </div>
                    </dl>
                </div>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5">
                    <h3 class="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                        <i class="fas fa-calendar-alt text-teal-500"></i> Tanggal
                    </h3>
                    <dl class="text-sm space-y-2">
                        <div class="flex justify-between gap-4 py-1 border-b border-gray-50">
                            <dt class="text-gray-500 whitespace-nowrap">Report Date</dt>
                        ...
                        <div class="flex justify-between gap-4 py-1 border-b border-gray-50">
                            <dt class="text-gray-500 whitespace-nowrap">Status Date</dt>
                            <dd class="font-medium text-gray-800 text-right">{{ $sr['statusdate'] }}</dd>
                        </div>
                    </dl>
                </div>
            </div>

            {{-- Detil SR (Long Description) --}}
            <div class="bg-white rounded-xl shadow-sm border border-gray-100 p-5 mt-5">
                <h3 class="text-sm font-semibold text-gray-700 mb-3 flex items-center gap-2">
                    <i class="fas fa-file-alt text-orange-500"></i> Detil SR
                </h3>
                ...
                @else
                <div class="p-4 bg-gray-50 rounded-lg text-sm text-gray-400 italic">Tidak ada data detil SR</div>
                @endif
            </div>

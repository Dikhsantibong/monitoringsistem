...
Route::get('/notulen/attendance/scan/{token}', [NotulenController::class, 'scanAttendance'])
    ->name('notulen.scan-attendance')
    ->withoutMiddleware(['auth']);

Route::post('/notulen/attendance/submit/{token}', [NotulenController::class, 'submitAttendance'])
    ->name('notulen.submit-attendance')
    ->withoutMiddleware(['auth']);
